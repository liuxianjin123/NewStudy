...
(function ($) {
    ...
    var default_options = {
        ...
        scrollTime: true,
        scrollInput: true,
        mask: '9999-19-39 29:59',//mask:false,  默认
        validateOnBlur: true,
        allowBlank: true,
        yearStart: 1950,
        yearEnd: 2050,
        ...
        var KEY0 = 48,
            ...
            createDateTimePicker = function (input) {
                var datetimepicker = $('<div ' + (options.id ? 'id="' + options.id + '"' : '') + ' ' + (options.style ? 'style="' + options.style + '"' : '') + ' class="xdsoft_datetimepicker xdsoft_noselect ' + options.className + '"></div>'),
                    ...
                    mounth_picker = $('<div class="xdsoft_mounthpicker"><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_today_button"></button><button type="button" class="xdsoft_clear_button"></button><div class="xdsoft_label xdsoft_month"><span></span></div><div class="xdsoft_label xdsoft_year"><span></span></div><button type="button" class="xdsoft_next"></button></div>'),
                ...
                mounth_picker
                    ...
                    .on('mousedown.xdsoft', function () {
                        if (options.onSelectDate && options.onSelectDate.call) {
                            options.onSelectDate.call(datetimepicker, '', datetimepicker.data('input'));
                        }
                        if (options.onSelectTime && options.onSelectTime.call) {
                            options.onSelectTime.call(datetimepicker, '', datetimepicker.data('input'));
                        }
                        input.val('');
                        datetimepicker.trigger('close.xdsoft');
                    }).on('dblclick.xdsoft', function () {
