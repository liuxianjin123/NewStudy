...
function(n, e) {
    ...
    return function(n) {
        ...
        function i(a) {
            ...
            return n[a].call(u.exports, u, u.exports, i),
            u.l = !0,
            u.exports
        }
        return i.m = n,
        ...
        i.t = function(n, e) {
            ...
            if (i.r(a), Object.defineProperty(a, "default", {
                enumerable: !0,
                value: n
            }), 2 & e && "string" != typeof n) for (var u in n) i.d(a, u,
            function(e) {
                return n[e]
            }.bind(null, u));
            return a
        ...
        u = Object.keys(a);
        e.pinyin_dict_notone = a,
        e.allPinyin = u
    },
    function(n, e, i) {
        "use strict";
        var a = i(0).pinyin_dict_notone,
        u = i(0).allPinyin,
        o = function() {
            var n = {};
        ...
        function r(n) {
            ...
            return function n(e, i, a, o, t) {
                ...
                for (var r = function(r) {
                    var g = i.substring(e, r + 1),
                    h = !1;
                    if (u.some((function(n) {
                        return 0 === n.indexOf(g)
                    })) && !i[r + 1] && t[r + 1]) {
                        if (1 === g.length) a.push(g);
                        else {
                            var f = [];
        ...
        function g(n) {
            ...
            return r(n).forEach((function(n) {
                ...
                i[a].indexOf(",") ? i[a].split(",").forEach((function(n) {
                    i.splice(a, 1, n),
                    e.push(JSON.parse(JSON.stringify(i)))
                })) : e.push(i)
            })),
            0 !== e.length && e[0].length === n.length || e.push(n.split("")),
            t = function(n, e, i) {
        ...
        function f(n, e, i) {
            for (var a = 0; a < n.length; a++) for (var u = 0; u < e.length; u++) {
                ...
                l = 0;
                if (t <= n.length) {
                    for (; f < o.length; f++) if (0 === f && " " === n[a + f + c]) c += 1,
                    f -= 1;
                    else if (" " === n[a + f + l]) l += 1,
                    f -= 1;
                    else if (!h(n[a + f + l], o[f], !n[a + f + 1] || !o[f + 1], r)) {
                        g = !1;
                        break
                    }
